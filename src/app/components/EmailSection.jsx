    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://www.instagram.com/mv_experiences/" rel="noopener noreferrer" target="_blank">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-teal-500 hover:bg-blue-600 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
          </form>
